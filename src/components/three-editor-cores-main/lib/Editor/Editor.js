...
import { setMainPanel, openControlPanel, controlPanelManager } from './RootPanel/MainPanel'
...
import {
	modelControls,
	modelControlsInstall,
	getModelControlsStorage,
	setModelControlsPanel,
} from './ModelControls'
import {
	innerMeshControls,
	getInnerMeshListStorage,
	setInnerMeshListStorage,
	setInnerMeshControlsPanel,
} from './InnerMeshControls'
import {
	drawControls,
	getDrawMeshListStorage,
	setDrawMeshListStorage,
	setDrawControlsPanel,
} from './DrawControls'
import {
	chartsMapControls,
	getGeoGroupListStorage,
	setGeoGroupListStorage,
	setChartsMapControlsPanel,
} from './ChartsMapControls'
import {
	particleControls,
	getParticleListStorage,
	setParticleListStorage,
	setParticleControlsPanel,
} from './ParticleControls'
import {
	borderGroupControls,
	getBorderGroupListStorage,
	setBorderGroupListStorage,
	setBorderGroupControlsPanel,
} from './BorderGroupControls'
import {
	textMeshControls,
	getTextMeshListStorage,
	setTextMeshListStorage,
	setTextMeshControlsPanel,
} from './TextMeshControls'
...
export function initSceneEditor(
	...
	function saveSceneEditor() {
		...
		const modelParams = getModelControlsStorage(scene.tempStorage.modelList)
		setSceneParams(sceneParams, modelParams)
	...
	/* 存储 还原 */
	setCoreStorage(
		{ chartsMapControls, particleControls, borderGroupControls, textMeshControls },
		sceneParams.core,
	)
